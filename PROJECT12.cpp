...
// where Tc
//  is the temperature of the air in degrees Celsius and the velocity is 
// in meters/second.
...
int main(){
    int n,m;
    cout<<"Enter starting point of tempreture range: ";
    cin>>n;
    cout<<"Enter closing point of tempreture range: ";
    cin>>m;
    for (int i = n; i <=m; i++)
    {
        double velocity = 331.3+ double (0.61*i);
